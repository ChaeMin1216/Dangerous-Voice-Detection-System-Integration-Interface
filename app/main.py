...
# 설정할 파일 저장 경로
UPLOAD_DIRECTORY = "/home/jaehoon/바탕화면/audio_predict/raw_data" #저장된 데이터 디렉터리의 정확한 위치 기입
...
async def monitor_and_process(directory: str):
    ...
    audiofile_path = Path('../audio_storage') #처리 완료된 파일을 보낼 정확한 디렉터리 위치 기입
...
async def startup_event():
    raw_audio_directory = "../raw_data/" #저장된 데이터의 정확한 디렉터리 위치 기입
